...
(function() {
     ...
     * @returns {string}
     */
    __exports.calculate_nfp = function(input) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.calculate_nfp(ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
     ...
     * @returns {string}
     */
    __exports.calculate_nfp_batch = function(input) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.calculate_nfp_batch(ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
